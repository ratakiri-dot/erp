...
export default function RecipesView() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingRecipe) {
                // Update
                // We use product_id as primary key and specify it for the helper
                await db.update('recipes', editingRecipe.product_id, recipeData, 'product_id');
            } else {
                        ...
                        return (
                            <tr key={recipe.id || idx}>
                                ...
                                <td>
                                    ...
                                    <button onClick={() => handleDelete(recipe)} style={{ color: '#ff4d4f', background: 'none', border: 'none', cursor: 'pointer' }}>
                                        Hapus
                                    </button>
                                </td>
                            </tr>
